...
void        InitDefaultsLockInfo();
void        InitDefaultsKeyErrorImpl();
void        InitDefaultsKeyError();
void        InitDefaultsWriteConflictImpl();
void        InitDefaultsWriteConflict();
void        InitDefaultsContextImpl();
void        InitDefaultsContext();
void        InitDefaultsHandleTimeImpl();
void        InitDefaultsHandleTime();
void        InitDefaultsScanInfoImpl();
void        InitDefaultsScanInfo();
void        InitDefaultsScanDetailImpl();
void        InitDefaultsScanDetail();
void        InitDefaultsExecDetailsImpl();
void        InitDefaultsExecDetails();
void        InitDefaultsGetRequestImpl();
void        InitDefaultsGetRequest();
void        InitDefaultsGetResponseImpl();
void        InitDefaultsGetResponse();
void        InitDefaultsScanRequestImpl();
void        InitDefaultsScanRequest();
void        InitDefaultsKvPairImpl();
void        InitDefaultsKvPair();
void        InitDefaultsScanResponseImpl();
void        InitDefaultsScanResponse();
...
void        InitDefaultsImportRequestImpl();
void        InitDefaultsImportRequest();
void        InitDefaultsImportResponseImpl();
void        InitDefaultsImportResponse();
void        InitDefaultsBatchRollbackRequestImpl();
void        InitDefaultsBatchRollbackRequest();
void        InitDefaultsBatchRollbackResponseImpl();
void        InitDefaultsBatchRollbackResponse();
void        InitDefaultsCleanupRequestImpl();
void        InitDefaultsCleanupRequest();
void        InitDefaultsCleanupResponseImpl();
void        InitDefaultsCleanupResponse();
void        InitDefaultsBatchGetRequestImpl();
void        InitDefaultsBatchGetRequest();
void        InitDefaultsBatchGetResponseImpl();
void        InitDefaultsBatchGetResponse();
void        InitDefaultsScanLockRequestImpl();
void        InitDefaultsScanLockRequest();
void        InitDefaultsScanLockResponseImpl();
void        InitDefaultsScanLockResponse();
void        InitDefaultsTxnInfoImpl();
void        InitDefaultsTxnInfo();
void        InitDefaultsResolveLockRequestImpl();
void        InitDefaultsResolveLockRequest();
void        InitDefaultsResolveLockResponseImpl();
void        InitDefaultsResolveLockResponse();
void        InitDefaultsGCRequestImpl();
void        InitDefaultsGCRequest();
void        InitDefaultsGCResponseImpl();
void        InitDefaultsGCResponse();
void        InitDefaultsRawGetRequestImpl();
void        InitDefaultsRawGetRequest();
void        InitDefaultsRawGetResponseImpl();
void        InitDefaultsRawGetResponse();
void        InitDefaultsRawPutRequestImpl();
void        InitDefaultsRawPutRequest();
void        InitDefaultsRawPutResponseImpl();
void        InitDefaultsRawPutResponse();
void        InitDefaultsRawBatchPutRequestImpl();
void        InitDefaultsRawBatchPutRequest();
void        InitDefaultsRawBatchPutResponseImpl();
void        InitDefaultsRawBatchPutResponse();
void        InitDefaultsRawBatchGetRequestImpl();
void        InitDefaultsRawBatchGetRequest();
void        InitDefaultsRawBatchGetResponseImpl();
void        InitDefaultsRawBatchGetResponse();
void        InitDefaultsRawDeleteRequestImpl();
void        InitDefaultsRawDeleteRequest();
void        InitDefaultsRawDeleteResponseImpl();
void        InitDefaultsRawDeleteResponse();
void        InitDefaultsRawBatchDeleteRequestImpl();
void        InitDefaultsRawBatchDeleteRequest();
void        InitDefaultsRawBatchDeleteResponseImpl();
void        InitDefaultsRawBatchDeleteResponse();
...
void        InitDefaultsRawDeleteRangeRequestImpl();
void        InitDefaultsRawDeleteRangeRequest();
void        InitDefaultsRawDeleteRangeResponseImpl();
void        InitDefaultsRawDeleteRangeResponse();
void        InitDefaultsRawScanRequestImpl();
void        InitDefaultsRawScanRequest();
void        InitDefaultsRawScanResponseImpl();
void        InitDefaultsRawScanResponse();
void        InitDefaultsKeyRangeImpl();
void        InitDefaultsKeyRange();
void        InitDefaultsRawBatchScanRequestImpl();
void        InitDefaultsRawBatchScanRequest();
void        InitDefaultsRawBatchScanResponseImpl();
void        InitDefaultsRawBatchScanResponse();
void        InitDefaultsMvccWriteImpl();
void        InitDefaultsMvccWrite();
void        InitDefaultsMvccValueImpl();
void        InitDefaultsMvccValue();
void        InitDefaultsMvccLockImpl();
void        InitDefaultsMvccLock();
void        InitDefaultsMvccInfoImpl();
void        InitDefaultsMvccInfo();
void        InitDefaultsMvccGetByKeyRequestImpl();
void        InitDefaultsMvccGetByKeyRequest();
void        InitDefaultsMvccGetByKeyResponseImpl();
void        InitDefaultsMvccGetByKeyResponse();
void        InitDefaultsMvccGetByStartTsRequestImpl();
void        InitDefaultsMvccGetByStartTsRequest();
void        InitDefaultsMvccGetByStartTsResponseImpl();
void        InitDefaultsMvccGetByStartTsResponse();
void        InitDefaultsSplitRegionRequestImpl();
void        InitDefaultsSplitRegionRequest();
void        InitDefaultsSplitRegionResponseImpl();
void        InitDefaultsSplitRegionResponse();
void        InitDefaultsUnsafeDestroyRangeRequestImpl();
...
inline void InitDefaults()
{
    ...
    InitDefaultsWriteConflict();
    InitDefaultsContext();
    InitDefaultsHandleTime();
    InitDefaultsScanInfo();
    InitDefaultsScanDetail();
    InitDefaultsExecDetails();
    InitDefaultsGetRequest();
    InitDefaultsGetResponse();
    InitDefaultsScanRequest();
    InitDefaultsKvPair();
    InitDefaultsScanResponse();
    ...
    InitDefaultsImportRequest();
    InitDefaultsImportResponse();
    InitDefaultsBatchRollbackRequest();
    InitDefaultsBatchRollbackResponse();
    InitDefaultsCleanupRequest();
    InitDefaultsCleanupResponse();
    InitDefaultsBatchGetRequest();
    InitDefaultsBatchGetResponse();
    InitDefaultsScanLockRequest();
    InitDefaultsScanLockResponse();
    InitDefaultsTxnInfo();
    InitDefaultsResolveLockRequest();
    InitDefaultsResolveLockResponse();
    InitDefaultsGCRequest();
    InitDefaultsGCResponse();
    InitDefaultsRawGetRequest();
    InitDefaultsRawGetResponse();
    InitDefaultsRawPutRequest();
    InitDefaultsRawPutResponse();
    InitDefaultsRawBatchPutRequest();
    InitDefaultsRawBatchPutResponse();
    InitDefaultsRawBatchGetRequest();
    InitDefaultsRawBatchGetResponse();
    InitDefaultsRawDeleteRequest();
    InitDefaultsRawDeleteResponse();
    InitDefaultsRawBatchDeleteRequest();
    InitDefaultsRawBatchDeleteResponse();
    InitDefaultsDeleteRangeRequest();
    InitDefaultsDeleteRangeResponse();
    InitDefaultsRawDeleteRangeRequest();
    InitDefaultsRawDeleteRangeResponse();
    InitDefaultsRawScanRequest();
    InitDefaultsRawScanResponse();
    InitDefaultsKeyRange();
    InitDefaultsRawBatchScanRequest();
    InitDefaultsRawBatchScanResponse();
    InitDefaultsMvccWrite();
    InitDefaultsMvccValue();
    InitDefaultsMvccLock();
    InitDefaultsMvccInfo();
    InitDefaultsMvccGetByKeyRequest();
    InitDefaultsMvccGetByKeyResponse();
    InitDefaultsMvccGetByStartTsRequest();
    InitDefaultsMvccGetByStartTsResponse();
    InitDefaultsSplitRegionRequest();
...
class UnsafeDestroyRangeRequestDefaultTypeInternal;
extern UnsafeDestroyRangeRequestDefaultTypeInternal _UnsafeDestroyRangeRequest_default_instance_;
class UnsafeDestroyRangeResponse;
class UnsafeDestroyRangeResponseDefaultTypeInternal;
extern UnsafeDestroyRangeResponseDefaultTypeInternal _UnsafeDestroyRangeResponse_default_instance_;
class WriteConflict;
...
{
    return ::google::protobuf::internal::NameOfEnum(CommandPri_descriptor(), value);
}
inline bool CommandPri_Parse(const ::std::string & name, CommandPri * value)
{
    return ::google::protobuf::internal::ParseNamedEnum<CommandPri>(CommandPri_descriptor(), name, value);
}
enum IsolationLevel
{
    SI                                          = 0,
...
{
    return ::google::protobuf::internal::NameOfEnum(IsolationLevel_descriptor(), value);
}
inline bool IsolationLevel_Parse(const ::std::string & name, IsolationLevel * value)
{
    return ::google::protobuf::internal::ParseNamedEnum<IsolationLevel>(IsolationLevel_descriptor(), name, value);
}
enum Op
{
    Put                             = 0,
...
{
    return ::google::protobuf::internal::NameOfEnum(Op_descriptor(), value);
}
inline bool Op_Parse(const ::std::string & name, Op * value)
{
    return ::google::protobuf::internal::ParseNamedEnum<Op>(Op_descriptor(), name, value);
}
// ===================================================================
...
public:
...
#if LANG_CXX11
    LockInfo(LockInfo && from) noexcept : LockInfo() { *this = ::std::move(from); }
    ...
    static inline const LockInfo * internal_default_instance() { return reinterpret_cast<const LockInfo *>(&_LockInfo_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 0;

    void        Swap(LockInfo * other);
    friend void swap(LockInfo & a, LockInfo & b) { a.Swap(&b); }
...
private:
    ...
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsLockInfoImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    KeyError(KeyError && from) noexcept : KeyError() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const KeyError * internal_default_instance() { return reinterpret_cast<const KeyError *>(&_KeyError_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 1;

    void        Swap(KeyError * other);
    friend void swap(KeyError & a, KeyError & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline KeyError * New() const PROTOBUF_FINAL { return New(NULL); }

    KeyError * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void       CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void       MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsKeyErrorImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    WriteConflict(WriteConflict && from) noexcept : WriteConflict() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const WriteConflict *>(&_WriteConflict_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 2;

    void        Swap(WriteConflict * other);
    friend void swap(WriteConflict & a, WriteConflict & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline WriteConflict * New() const PROTOBUF_FINAL { return New(NULL); }

    WriteConflict * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void            CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void            MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsWriteConflictImpl();
};
// -------------------------------------------------------------------
...
public:
    ...
    static void                   InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const Context * internal_default_instance() { return reinterpret_cast<const Context *>(&_Context_default_instance_); }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsContextImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    HandleTime(HandleTime && from) noexcept : HandleTime() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const HandleTime *>(&_HandleTime_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 4;

    void        Swap(HandleTime * other);
    friend void swap(HandleTime & a, HandleTime & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline HandleTime * New() const PROTOBUF_FINAL { return New(NULL); }

    HandleTime * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void         CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void         MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsHandleTimeImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanInfo(ScanInfo && from) noexcept : ScanInfo() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const ScanInfo * internal_default_instance() { return reinterpret_cast<const ScanInfo *>(&_ScanInfo_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 5;

    void        Swap(ScanInfo * other);
    friend void swap(ScanInfo & a, ScanInfo & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ScanInfo * New() const PROTOBUF_FINAL { return New(NULL); }

    ScanInfo * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void       CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void       MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanInfoImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanDetail(ScanDetail && from) noexcept : ScanDetail() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ScanDetail *>(&_ScanDetail_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 6;

    void        Swap(ScanDetail * other);
    friend void swap(ScanDetail & a, ScanDetail & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ScanDetail * New() const PROTOBUF_FINAL { return New(NULL); }

    ScanDetail * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void         CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void         MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanDetailImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ExecDetails(ExecDetails && from) noexcept : ExecDetails() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ExecDetails *>(&_ExecDetails_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 7;

    void        Swap(ExecDetails * other);
    friend void swap(ExecDetails & a, ExecDetails & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ExecDetails * New() const PROTOBUF_FINAL { return New(NULL); }

    ExecDetails * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void          CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void          MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsExecDetailsImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    GetRequest(GetRequest && from) noexcept : GetRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const GetRequest *>(&_GetRequest_default_instance_);
    }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsGetRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    GetResponse(GetResponse && from) noexcept : GetResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const GetResponse *>(&_GetResponse_default_instance_);
    }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsGetResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanRequest(ScanRequest && from) noexcept : ScanRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ScanRequest *>(&_ScanRequest_default_instance_);
    }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    KvPair(KvPair && from) noexcept : KvPair() { *this = ::std::move(from); }
    ...
    static void                         InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const KvPair *        internal_default_instance() { return reinterpret_cast<const KvPair *>(&_KvPair_default_instance_); }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsKvPairImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanResponse(ScanResponse && from) noexcept : ScanResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ScanResponse *>(&_ScanResponse_default_instance_);
    }
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> *       mutable_pairs();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> & pairs() const;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    Mutation(Mutation && from) noexcept : Mutation() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const Mutation * internal_default_instance() { return reinterpret_cast<const Mutation *>(&_Mutation_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 13;

    void        Swap(Mutation * other);
    friend void swap(Mutation & a, Mutation & b) { a.Swap(&b); }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMutationImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    PrewriteRequest(PrewriteRequest && from) noexcept : PrewriteRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const PrewriteRequest *>(&_PrewriteRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 14;

    void        Swap(PrewriteRequest * other);
    friend void swap(PrewriteRequest & a, PrewriteRequest & b) { a.Swap(&b); }
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> *       mutable_mutations();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> & mutations() const;
...
private:
    ...
    mutable int                                               _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsPrewriteRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    PrewriteResponse(PrewriteResponse && from) noexcept : PrewriteResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const PrewriteResponse *>(&_PrewriteResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 15;

    void        Swap(PrewriteResponse * other);
    friend void swap(PrewriteResponse & a, PrewriteResponse & b) { a.Swap(&b); }
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyError> *       mutable_errors();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyError> & errors() const;
...
private:
    ...
    mutable int                                               _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsPrewriteResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    CommitRequest(CommitRequest && from) noexcept : CommitRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const CommitRequest *>(&_CommitRequest_default_instance_);
    }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsCommitRequestImpl();
};
// -------------------------------------------------------------------
...
#if LANG_CXX11
    CommitResponse(CommitResponse && from) noexcept : CommitResponse() { *this = ::std::move(from); }
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsCommitResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ImportRequest(ImportRequest && from) noexcept : ImportRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ImportRequest *>(&_ImportRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 18;

    void        Swap(ImportRequest * other);
    friend void swap(ImportRequest & a, ImportRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ImportRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    ImportRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void            CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void            MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                               _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsImportRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ImportResponse(ImportResponse && from) noexcept : ImportResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ImportResponse *>(&_ImportResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 19;

    void        Swap(ImportResponse * other);
    friend void swap(ImportResponse & a, ImportResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ImportResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    ImportResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void             CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void             MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsImportResponseImpl();
};
// -------------------------------------------------------------------

class BatchRollbackRequest
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.BatchRollbackRequest) */
{
public:
...
#if LANG_CXX11
    BatchRollbackRequest(BatchRollbackRequest && from) noexcept : BatchRollbackRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const BatchRollbackRequest *>(&_BatchRollbackRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 20;

    void        Swap(BatchRollbackRequest * other);
    friend void swap(BatchRollbackRequest & a, BatchRollbackRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline BatchRollbackRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    BatchRollbackRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                   CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                   MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsBatchRollbackRequestImpl();
};
// -------------------------------------------------------------------

class BatchRollbackResponse
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.BatchRollbackResponse) */
{
public:
...
#if LANG_CXX11
    BatchRollbackResponse(BatchRollbackResponse && from) noexcept : BatchRollbackResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const BatchRollbackResponse *>(&_BatchRollbackResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 21;

    void        Swap(BatchRollbackResponse * other);
    friend void swap(BatchRollbackResponse & a, BatchRollbackResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline BatchRollbackResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    BatchRollbackResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                    CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                    MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsBatchRollbackResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    CleanupRequest(CleanupRequest && from) noexcept : CleanupRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const CleanupRequest *>(&_CleanupRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 22;

    void        Swap(CleanupRequest * other);
    friend void swap(CleanupRequest & a, CleanupRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline CleanupRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    CleanupRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void             CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void             MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsCleanupRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    CleanupResponse(CleanupResponse && from) noexcept : CleanupResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const CleanupResponse *>(&_CleanupResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 23;

    void        Swap(CleanupResponse * other);
    friend void swap(CleanupResponse & a, CleanupResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline CleanupResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    CleanupResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void              CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void              MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsCleanupResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    BatchGetRequest(BatchGetRequest && from) noexcept : BatchGetRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const BatchGetRequest *>(&_BatchGetRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 24;

    void        Swap(BatchGetRequest * other);
    friend void swap(BatchGetRequest & a, BatchGetRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline BatchGetRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    BatchGetRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void              CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void              MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsBatchGetRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    BatchGetResponse(BatchGetResponse && from) noexcept : BatchGetResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const BatchGetResponse *>(&_BatchGetResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 25;

    void        Swap(BatchGetResponse * other);
    friend void swap(BatchGetResponse & a, BatchGetResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline BatchGetResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    BatchGetResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void               CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void               MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsBatchGetResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanLockRequest(ScanLockRequest && from) noexcept : ScanLockRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ScanLockRequest *>(&_ScanLockRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 26;

    void        Swap(ScanLockRequest * other);
    friend void swap(ScanLockRequest & a, ScanLockRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ScanLockRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    ScanLockRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void              CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void              MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanLockRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ScanLockResponse(ScanLockResponse && from) noexcept : ScanLockResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ScanLockResponse *>(&_ScanLockResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 27;

    void        Swap(ScanLockResponse * other);
    friend void swap(ScanLockResponse & a, ScanLockResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ScanLockResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    ScanLockResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void               CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void               MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::LockInfo> *       mutable_locks();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::LockInfo> & locks() const;
...
private:
    ...
    mutable int                                               _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsScanLockResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    TxnInfo(TxnInfo && from) noexcept : TxnInfo() { *this = ::std::move(from); }
    ...
    static void                   InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const TxnInfo * internal_default_instance() { return reinterpret_cast<const TxnInfo *>(&_TxnInfo_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 28;

    void        Swap(TxnInfo * other);
    friend void swap(TxnInfo & a, TxnInfo & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline TxnInfo * New() const PROTOBUF_FINAL { return New(NULL); }

    TxnInfo * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void      CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void      MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsTxnInfoImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ResolveLockRequest(ResolveLockRequest && from) noexcept : ResolveLockRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ResolveLockRequest *>(&_ResolveLockRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 29;

    void        Swap(ResolveLockRequest * other);
    friend void swap(ResolveLockRequest & a, ResolveLockRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ResolveLockRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    ResolveLockRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                 CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                 MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::TxnInfo> *       mutable_txn_infos();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::TxnInfo> & txn_infos() const;
...
private:
    ...
    mutable int                                              _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsResolveLockRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    ResolveLockResponse(ResolveLockResponse && from) noexcept : ResolveLockResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const ResolveLockResponse *>(&_ResolveLockResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 30;

    void        Swap(ResolveLockResponse * other);
    friend void swap(ResolveLockResponse & a, ResolveLockResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline ResolveLockResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    ResolveLockResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsResolveLockResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    GCRequest(GCRequest && from) noexcept : GCRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const GCRequest *>(&_GCRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 31;

    void        Swap(GCRequest * other);
    friend void swap(GCRequest & a, GCRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline GCRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    GCRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void        CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void        MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsGCRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    GCResponse(GCResponse && from) noexcept : GCResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const GCResponse *>(&_GCResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 32;

    void        Swap(GCResponse * other);
    friend void swap(GCResponse & a, GCResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline GCResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    GCResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void         CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void         MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsGCResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawGetRequest(RawGetRequest && from) noexcept : RawGetRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawGetRequest *>(&_RawGetRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 33;

    void        Swap(RawGetRequest * other);
    friend void swap(RawGetRequest & a, RawGetRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawGetRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawGetRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void            CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void            MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawGetRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawGetResponse(RawGetResponse && from) noexcept : RawGetResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawGetResponse *>(&_RawGetResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 34;

    void        Swap(RawGetResponse * other);
    friend void swap(RawGetResponse & a, RawGetResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawGetResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawGetResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void             CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void             MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawGetResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawPutRequest(RawPutRequest && from) noexcept : RawPutRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawPutRequest *>(&_RawPutRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 35;

    void        Swap(RawPutRequest * other);
    friend void swap(RawPutRequest & a, RawPutRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawPutRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawPutRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void            CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void            MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawPutRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawPutResponse(RawPutResponse && from) noexcept : RawPutResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawPutResponse *>(&_RawPutResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 36;

    void        Swap(RawPutResponse * other);
    friend void swap(RawPutResponse & a, RawPutResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawPutResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawPutResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void             CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void             MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawPutResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchPutRequest(RawBatchPutRequest && from) noexcept : RawBatchPutRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchPutRequest *>(&_RawBatchPutRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 37;

    void        Swap(RawBatchPutRequest * other);
    friend void swap(RawBatchPutRequest & a, RawBatchPutRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchPutRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchPutRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                 CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                 MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchPutRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchPutResponse(RawBatchPutResponse && from) noexcept : RawBatchPutResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchPutResponse *>(&_RawBatchPutResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 38;

    void        Swap(RawBatchPutResponse * other);
    friend void swap(RawBatchPutResponse & a, RawBatchPutResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchPutResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchPutResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchPutResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchGetRequest(RawBatchGetRequest && from) noexcept : RawBatchGetRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchGetRequest *>(&_RawBatchGetRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 39;

    void        Swap(RawBatchGetRequest * other);
    friend void swap(RawBatchGetRequest & a, RawBatchGetRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchGetRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchGetRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                 CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                 MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchGetRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchGetResponse(RawBatchGetResponse && from) noexcept : RawBatchGetResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchGetResponse *>(&_RawBatchGetResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 40;

    void        Swap(RawBatchGetResponse * other);
    friend void swap(RawBatchGetResponse & a, RawBatchGetResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchGetResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchGetResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchGetResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawDeleteRequest(RawDeleteRequest && from) noexcept : RawDeleteRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawDeleteRequest *>(&_RawDeleteRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 41;

    void        Swap(RawDeleteRequest * other);
    friend void swap(RawDeleteRequest & a, RawDeleteRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawDeleteRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawDeleteRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void               CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void               MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawDeleteRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawDeleteResponse(RawDeleteResponse && from) noexcept : RawDeleteResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawDeleteResponse *>(&_RawDeleteResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 42;

    void        Swap(RawDeleteResponse * other);
    friend void swap(RawDeleteResponse & a, RawDeleteResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawDeleteResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawDeleteResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawDeleteResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchDeleteRequest(RawBatchDeleteRequest && from) noexcept : RawBatchDeleteRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchDeleteRequest *>(&_RawBatchDeleteRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 43;

    void        Swap(RawBatchDeleteRequest * other);
    friend void swap(RawBatchDeleteRequest & a, RawBatchDeleteRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchDeleteRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchDeleteRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                    CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                    MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchDeleteRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchDeleteResponse(RawBatchDeleteResponse && from) noexcept : RawBatchDeleteResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchDeleteResponse *>(&_RawBatchDeleteResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 44;

    void        Swap(RawBatchDeleteResponse * other);
    friend void swap(RawBatchDeleteResponse & a, RawBatchDeleteResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchDeleteResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchDeleteResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                     CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                     MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchDeleteResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    DeleteRangeRequest(DeleteRangeRequest && from) noexcept : DeleteRangeRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const DeleteRangeRequest *>(&_DeleteRangeRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 45;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsDeleteRangeRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    DeleteRangeResponse(DeleteRangeResponse && from) noexcept : DeleteRangeResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const DeleteRangeResponse *>(&_DeleteRangeResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 46;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsDeleteRangeResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawDeleteRangeRequest(RawDeleteRangeRequest && from) noexcept : RawDeleteRangeRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawDeleteRangeRequest *>(&_RawDeleteRangeRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 47;

    void        Swap(RawDeleteRangeRequest * other);
    friend void swap(RawDeleteRangeRequest & a, RawDeleteRangeRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawDeleteRangeRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawDeleteRangeRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                    CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                    MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawDeleteRangeRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawDeleteRangeResponse(RawDeleteRangeResponse && from) noexcept : RawDeleteRangeResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawDeleteRangeResponse *>(&_RawDeleteRangeResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 48;

    void        Swap(RawDeleteRangeResponse * other);
    friend void swap(RawDeleteRangeResponse & a, RawDeleteRangeResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawDeleteRangeResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawDeleteRangeResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                     CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                     MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawDeleteRangeResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawScanRequest(RawScanRequest && from) noexcept : RawScanRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawScanRequest *>(&_RawScanRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 49;

    void        Swap(RawScanRequest * other);
    friend void swap(RawScanRequest & a, RawScanRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawScanRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawScanRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void             CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void             MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
...
#if LANG_CXX11
    RawScanResponse(RawScanResponse && from) noexcept : RawScanResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawScanResponse *>(&_RawScanResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 50;

    void        Swap(RawScanResponse * other);
    friend void swap(RawScanResponse & a, RawScanResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawScanResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawScanResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void              CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void              MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> *       mutable_kvs();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> & kvs() const;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawScanResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    KeyRange(KeyRange && from) noexcept : KeyRange() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const KeyRange * internal_default_instance() { return reinterpret_cast<const KeyRange *>(&_KeyRange_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 51;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsKeyRangeImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    RawBatchScanRequest(RawBatchScanRequest && from) noexcept : RawBatchScanRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchScanRequest *>(&_RawBatchScanRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 52;

    void        Swap(RawBatchScanRequest * other);
    friend void swap(RawBatchScanRequest & a, RawBatchScanRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchScanRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchScanRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyRange> *       mutable_ranges();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyRange> & ranges() const;
...
class RawBatchScanResponse
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.RawBatchScanResponse) */
{
public:
...
#if LANG_CXX11
    RawBatchScanResponse(RawBatchScanResponse && from) noexcept : RawBatchScanResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const RawBatchScanResponse *>(&_RawBatchScanResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 53;

    void        Swap(RawBatchScanResponse * other);
    friend void swap(RawBatchScanResponse & a, RawBatchScanResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline RawBatchScanResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    RawBatchScanResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                   CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                   MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsRawBatchScanResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    MvccWrite(MvccWrite && from) noexcept : MvccWrite() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccWrite *>(&_MvccWrite_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 54;

    void        Swap(MvccWrite * other);
    friend void swap(MvccWrite & a, MvccWrite & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccWrite * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccWrite * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void        CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void        MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccWriteImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    MvccValue(MvccValue && from) noexcept : MvccValue() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccValue *>(&_MvccValue_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 55;

    void        Swap(MvccValue * other);
    friend void swap(MvccValue & a, MvccValue & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccValue * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccValue * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void        CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void        MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccValueImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    MvccLock(MvccLock && from) noexcept : MvccLock() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const MvccLock * internal_default_instance() { return reinterpret_cast<const MvccLock *>(&_MvccLock_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 56;

    void        Swap(MvccLock * other);
    friend void swap(MvccLock & a, MvccLock & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccLock * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccLock * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void       CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void       MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccLockImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    MvccInfo(MvccInfo && from) noexcept : MvccInfo() { *this = ::std::move(from); }
    ...
    static void                    InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const MvccInfo * internal_default_instance() { return reinterpret_cast<const MvccInfo *>(&_MvccInfo_default_instance_); }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 57;

    void        Swap(MvccInfo * other);
    friend void swap(MvccInfo & a, MvccInfo & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccInfo * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccInfo * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void       CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void       MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccWrite> *       mutable_writes();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccWrite> & writes() const;
    ...
    ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccValue> *       mutable_values();
    const ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccValue> & values() const;
...
private:
    ...
    mutable int                                                _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccInfoImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    MvccGetByKeyRequest(MvccGetByKeyRequest && from) noexcept : MvccGetByKeyRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccGetByKeyRequest *>(&_MvccGetByKeyRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 58;

    void        Swap(MvccGetByKeyRequest * other);
    friend void swap(MvccGetByKeyRequest & a, MvccGetByKeyRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccGetByKeyRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccGetByKeyRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccGetByKeyRequestImpl();
};
// -------------------------------------------------------------------

class MvccGetByKeyResponse
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.MvccGetByKeyResponse) */
{
public:
...
#if LANG_CXX11
    MvccGetByKeyResponse(MvccGetByKeyResponse && from) noexcept : MvccGetByKeyResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccGetByKeyResponse *>(&_MvccGetByKeyResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 59;

    void        Swap(MvccGetByKeyResponse * other);
    friend void swap(MvccGetByKeyResponse & a, MvccGetByKeyResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccGetByKeyResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccGetByKeyResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                   CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                   MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccGetByKeyResponseImpl();
};
// -------------------------------------------------------------------

class MvccGetByStartTsRequest
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.MvccGetByStartTsRequest) */
{
public:
...
#if LANG_CXX11
    MvccGetByStartTsRequest(MvccGetByStartTsRequest && from) noexcept : MvccGetByStartTsRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccGetByStartTsRequest *>(&_MvccGetByStartTsRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 60;

    void        Swap(MvccGetByStartTsRequest * other);
    friend void swap(MvccGetByStartTsRequest & a, MvccGetByStartTsRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccGetByStartTsRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccGetByStartTsRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                      CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                      MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccGetByStartTsRequestImpl();
};
// -------------------------------------------------------------------

class MvccGetByStartTsResponse
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.MvccGetByStartTsResponse) */
{
public:
...
#if LANG_CXX11
    MvccGetByStartTsResponse(MvccGetByStartTsResponse && from) noexcept : MvccGetByStartTsResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const MvccGetByStartTsResponse *>(&_MvccGetByStartTsResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 61;

    void        Swap(MvccGetByStartTsResponse * other);
    friend void swap(MvccGetByStartTsResponse & a, MvccGetByStartTsResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline MvccGetByStartTsResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    MvccGetByStartTsResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                       CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                       MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsMvccGetByStartTsResponseImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    SplitRegionRequest(SplitRegionRequest && from) noexcept : SplitRegionRequest() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const SplitRegionRequest *>(&_SplitRegionRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 62;

    void        Swap(SplitRegionRequest * other);
    friend void swap(SplitRegionRequest & a, SplitRegionRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline SplitRegionRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    SplitRegionRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                 CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                 MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsSplitRegionRequestImpl();
};
// -------------------------------------------------------------------
...
public:
...
#if LANG_CXX11
    SplitRegionResponse(SplitRegionResponse && from) noexcept : SplitRegionResponse() { *this = ::std::move(from); }
    ...
    {
        return reinterpret_cast<const SplitRegionResponse *>(&_SplitRegionResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 63;

    void        Swap(SplitRegionResponse * other);
    friend void swap(SplitRegionResponse & a, SplitRegionResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline SplitRegionResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    SplitRegionResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                  CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                  MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsSplitRegionResponseImpl();
};
// -------------------------------------------------------------------

class UnsafeDestroyRangeRequest
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.UnsafeDestroyRangeRequest) */
{
public:
...
#if LANG_CXX11
    UnsafeDestroyRangeRequest(UnsafeDestroyRangeRequest && from) noexcept : UnsafeDestroyRangeRequest() { *this = ::std::move(from); }

    inline UnsafeDestroyRangeRequest & operator=(UnsafeDestroyRangeRequest && from) noexcept
    {
        if (GetArenaNoVirtual() == from.GetArenaNoVirtual())
        {
            if (this != &from)
    ...
    static void                                     InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const UnsafeDestroyRangeRequest * internal_default_instance()
    {
        return reinterpret_cast<const UnsafeDestroyRangeRequest *>(&_UnsafeDestroyRangeRequest_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 64;

    void        Swap(UnsafeDestroyRangeRequest * other);
    friend void swap(UnsafeDestroyRangeRequest & a, UnsafeDestroyRangeRequest & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline UnsafeDestroyRangeRequest * New() const PROTOBUF_FINAL { return New(NULL); }

    UnsafeDestroyRangeRequest * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                        CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                        MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
private:
    ...
    mutable int                                             _cached_size_;
    friend struct ::protobuf_kvrpcpb_2eproto::TableStruct;
    friend void ::protobuf_kvrpcpb_2eproto::InitDefaultsUnsafeDestroyRangeRequestImpl();
};
// -------------------------------------------------------------------

class UnsafeDestroyRangeResponse
    : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.UnsafeDestroyRangeResponse) */
{
public:
...
#if LANG_CXX11
    UnsafeDestroyRangeResponse(UnsafeDestroyRangeResponse && from) noexcept : UnsafeDestroyRangeResponse() { *this = ::std::move(from); }

    inline UnsafeDestroyRangeResponse & operator=(UnsafeDestroyRangeResponse && from) noexcept
    {
        if (GetArenaNoVirtual() == from.GetArenaNoVirtual())
        {
            if (this != &from)
    ...
    static void                                      InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
    static inline const UnsafeDestroyRangeResponse * internal_default_instance()
    {
        return reinterpret_cast<const UnsafeDestroyRangeResponse *>(&_UnsafeDestroyRangeResponse_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages = 65;

    void        Swap(UnsafeDestroyRangeResponse * other);
    friend void swap(UnsafeDestroyRangeResponse & a, UnsafeDestroyRangeResponse & b) { a.Swap(&b); }

    // implements Message ----------------------------------------------

    inline UnsafeDestroyRangeResponse * New() const PROTOBUF_FINAL { return New(NULL); }

    UnsafeDestroyRangeResponse * New(::google::protobuf::Arena * arena) const PROTOBUF_FINAL;
    void                         CopyFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
    void                         MergeFrom(const ::google::protobuf::Message & from) PROTOBUF_FINAL;
...
inline void LockInfo::set_primary_lock(::std::string && value)
{
    ...
    primary_lock_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::kvrpcpb::LockInfo & KeyError::locked() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::LockInfo *>(&::kvrpcpb::_LockInfo_default_instance_);
}
...
inline void KeyError::set_allocated_locked(::kvrpcpb::LockInfo * locked)
{
    ...
    if (locked)
    {
        ...
        {
            locked = ::google::protobuf::internal::GetOwnedMessage(message_arena, locked, submessage_arena);
        }
    }
    else
    {
...
inline void KeyError::set_retryable(::std::string && value)
{
    ...
    retryable_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void KeyError::set_abort(::std::string && value)
{
    ...
    abort_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::kvrpcpb::WriteConflict & KeyError::conflict() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::WriteConflict *>(&::kvrpcpb::_WriteConflict_default_instance_);
}
...
inline void KeyError::set_allocated_conflict(::kvrpcpb::WriteConflict * conflict)
{
    ...
    if (conflict)
    {
        ...
        if (message_arena != submessage_arena)
        {
            conflict = ::google::protobuf::internal::GetOwnedMessage(message_arena, conflict, submessage_arena);
        }
    }
    else
    {
...
inline void WriteConflict::set_primary(::std::string && value)
{
    ...
    primary_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::kvrpcpb::ScanInfo & ScanDetail::write() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::ScanInfo *>(&::kvrpcpb::_ScanInfo_default_instance_);
}
...
inline void ScanDetail::set_allocated_lock(::kvrpcpb::ScanInfo * lock)
{
    ...
    if (lock)
    {
        ...
        if (message_arena != submessage_arena)
        {
            lock = ::google::protobuf::internal::GetOwnedMessage(message_arena, lock, submessage_arena);
        }
    }
    else
    {
...
inline const ::kvrpcpb::HandleTime & ExecDetails::handle_time() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::HandleTime *>(&::kvrpcpb::_HandleTime_default_instance_);
}
...
inline void ExecDetails::set_allocated_handle_time(::kvrpcpb::HandleTime * handle_time)
{
    ...
    if (handle_time)
    {
        ...
        if (message_arena != submessage_arena)
        {
            handle_time = ::google::protobuf::internal::GetOwnedMessage(message_arena, handle_time, submessage_arena);
        }
    }
    else
    {
...
inline const ::kvrpcpb::ScanDetail & ExecDetails::scan_detail() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::ScanDetail *>(&::kvrpcpb::_ScanDetail_default_instance_);
}
...
inline void ExecDetails::set_allocated_scan_detail(::kvrpcpb::ScanDetail * scan_detail)
{
    ...
    if (scan_detail)
    {
        ...
        if (message_arena != submessage_arena)
        {
            scan_detail = ::google::protobuf::internal::GetOwnedMessage(message_arena, scan_detail, submessage_arena);
        }
    }
    else
    {
...
inline void GetResponse::set_allocated_region_error(::errorpb::Error * region_error)
{
    ...
    if (region_error)
    {
        ...
        if (message_arena != submessage_arena)
        {
            region_error = ::google::protobuf::internal::GetOwnedMessage(message_arena, region_error, submessage_arena);
        }
    }
    else
    {
...
inline const ::kvrpcpb::KeyError & GetResponse::error() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::KeyError *>(&::kvrpcpb::_KeyError_default_instance_);
}
...
inline void GetResponse::set_value(::std::string && value)
{
    ...
    value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ScanRequest::set_start_key(::std::string && value)
{
    ...
    start_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> * ScanResponse::mutable_pairs()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.ScanResponse.pairs)
    return &pairs_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> & ScanResponse::pairs() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> * PrewriteRequest::mutable_mutations()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.PrewriteRequest.mutations)
    return &mutations_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> & PrewriteRequest::mutations() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyError> * PrewriteResponse::mutable_errors()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.PrewriteResponse.errors)
    return &errors_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyError> & PrewriteResponse::errors() const
{
...
inline const ::google::protobuf::RepeatedPtrField<::std::string> & CommitRequest::keys() const
{
    // @@protoc_insertion_point(field_list:kvrpcpb.CommitRequest.keys)
    return keys_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string> * CommitRequest::mutable_keys()
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> * ImportRequest::mutable_mutations()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.ImportRequest.mutations)
    return &mutations_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::Mutation> & ImportRequest::mutations() const
{
...
inline void ImportResponse::set_error(::std::string && value)
{
    ...
    error_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::google::protobuf::RepeatedPtrField<::std::string> & BatchRollbackRequest::keys() const
{
    // @@protoc_insertion_point(field_list:kvrpcpb.BatchRollbackRequest.keys)
    return keys_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string> * BatchRollbackRequest::mutable_keys()
{
...
inline const ::google::protobuf::RepeatedPtrField<::std::string> & BatchGetRequest::keys() const
{
    // @@protoc_insertion_point(field_list:kvrpcpb.BatchGetRequest.keys)
    return keys_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string> * BatchGetRequest::mutable_keys()
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> * BatchGetResponse::mutable_pairs()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.BatchGetResponse.pairs)
    return &pairs_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> & BatchGetResponse::pairs() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::LockInfo> * ScanLockResponse::mutable_locks()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.ScanLockResponse.locks)
    return &locks_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::LockInfo> & ScanLockResponse::locks() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::TxnInfo> * ResolveLockRequest::mutable_txn_infos()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.ResolveLockRequest.txn_infos)
    return &txn_infos_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::TxnInfo> & ResolveLockRequest::txn_infos() const
{
...
inline const ::google::protobuf::RepeatedPtrField<::std::string> & RawBatchGetRequest::keys() const
{
    // @@protoc_insertion_point(field_list:kvrpcpb.RawBatchGetRequest.keys)
    return keys_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string> * RawBatchGetRequest::mutable_keys()
{
...
inline const ::google::protobuf::RepeatedPtrField<::std::string> & RawBatchDeleteRequest::keys() const
{
    // @@protoc_insertion_point(field_list:kvrpcpb.RawBatchDeleteRequest.keys)
    return keys_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string> * RawBatchDeleteRequest::mutable_keys()
{
...
inline void DeleteRangeRequest::set_end_key(::std::string && value)
{
    ...
    end_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyRange> * RawBatchScanRequest::mutable_ranges()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.RawBatchScanRequest.ranges)
    return &ranges_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KeyRange> & RawBatchScanRequest::ranges() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> * RawBatchScanResponse::mutable_kvs()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.RawBatchScanResponse.kvs)
    return &kvs_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::KvPair> & RawBatchScanResponse::kvs() const
{
...
inline void MvccWrite::set_short_value(::std::string && value)
{
    ...
    short_value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::kvrpcpb::MvccLock & MvccInfo::lock() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::MvccLock *>(&::kvrpcpb::_MvccLock_default_instance_);
}
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccWrite> * MvccInfo::mutable_writes()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.MvccInfo.writes)
    return &writes_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccWrite> & MvccInfo::writes() const
{
...
inline ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccValue> * MvccInfo::mutable_values()
{
    // @@protoc_insertion_point(field_mutable_list:kvrpcpb.MvccInfo.values)
    return &values_;
}
inline const ::google::protobuf::RepeatedPtrField<::kvrpcpb::MvccValue> & MvccInfo::values() const
{
...
inline const ::kvrpcpb::MvccInfo & MvccGetByKeyResponse::info() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::MvccInfo *>(&::kvrpcpb::_MvccInfo_default_instance_);
}
...
inline void SplitRegionRequest::set_split_key(::std::string && value)
{
    ...
    split_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void SplitRegionResponse::set_allocated_left(::metapb::Region * left)
{
    ...
    if (left)
    {
        ...
        if (message_arena != submessage_arena)
        {
            left = ::google::protobuf::internal::GetOwnedMessage(message_arena, left, submessage_arena);
        }
    }
    else
    {
...
inline void SplitRegionResponse::set_allocated_right(::metapb::Region * right)
{
    ...
    if (right)
    {
        ...
        if (message_arena != submessage_arena)
        {
            right = ::google::protobuf::internal::GetOwnedMessage(message_arena, right, submessage_arena);
        }
    }
    else
    {
...
#if LANG_CXX11
inline void UnsafeDestroyRangeRequest::set_start_key(::std::string && value)
{

    start_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
    // @@protoc_insertion_point(field_set_rvalue:kvrpcpb.UnsafeDestroyRangeRequest.start_key)
}
#endif
...
#if LANG_CXX11
inline void UnsafeDestroyRangeRequest::set_end_key(::std::string && value)
{

    end_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
    // @@protoc_insertion_point(field_set_rvalue:kvrpcpb.UnsafeDestroyRangeRequest.end_key)
}
#endif
...
#if LANG_CXX11
inline void UnsafeDestroyRangeResponse::set_error(::std::string && value)
{

    error_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
    // @@protoc_insertion_point(field_set_rvalue:kvrpcpb.UnsafeDestroyRangeResponse.error)
}
#endif
...
template <>
struct is_proto_enum<::kvrpcpb::CommandPri> : ::google::protobuf::internal::true_type
{
};
template <>
...
template <>
struct is_proto_enum<::kvrpcpb::IsolationLevel> : ::google::protobuf::internal::true_type
{
};
template <>
...
template <>
struct is_proto_enum<::kvrpcpb::Op> : ::google::protobuf::internal::true_type
{
};
template <>
