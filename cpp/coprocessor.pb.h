...
public:
    ...
    ::google::protobuf::RepeatedPtrField<::coprocessor::KeyRange> *       mutable_ranges();
    const ::google::protobuf::RepeatedPtrField<::coprocessor::KeyRange> & ranges() const;
...
inline ::google::protobuf::RepeatedPtrField<::coprocessor::KeyRange> * Request::mutable_ranges()
{
    // @@protoc_insertion_point(field_mutable_list:coprocessor.Request.ranges)
    return &ranges_;
}
inline const ::google::protobuf::RepeatedPtrField<::coprocessor::KeyRange> & Request::ranges() const
{
...
inline void Response::set_other_error(::std::string && value)
{
    ...
    other_error_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline const ::coprocessor::KeyRange & Response::range() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::coprocessor::KeyRange *>(&::coprocessor::_KeyRange_default_instance_);
}
...
inline const ::kvrpcpb::ExecDetails & Response::exec_details() const
{
    ...
    return p != NULL ? *p : *reinterpret_cast<const ::kvrpcpb::ExecDetails *>(&::kvrpcpb::_ExecDetails_default_instance_);
}
...
inline void Response::set_allocated_exec_details(::kvrpcpb::ExecDetails * exec_details)
{
    ...
    if (exec_details)
    {
        ...
        if (message_arena != submessage_arena)
        {
            exec_details = ::google::protobuf::internal::GetOwnedMessage(message_arena, exec_details, submessage_arena);
        }
    }
    else
    {
