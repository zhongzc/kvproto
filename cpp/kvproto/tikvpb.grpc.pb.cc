...
::grpc::Status Tikv::Stub::UnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UnsafeDestroyRange_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>* Tikv::Stub::AsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::kvrpcpb::UnsafeDestroyRangeResponse>::Create(channel_.get(), cq, rpcmethod_UnsafeDestroyRange_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>* Tikv::Stub::PrepareAsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::kvrpcpb::UnsafeDestroyRangeResponse>::Create(channel_.get(), cq, rpcmethod_UnsafeDestroyRange_, context, request, false);
}
...
::grpc::Status Tikv::Service::UnsafeDestroyRange(::grpc::ServerContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest* request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
