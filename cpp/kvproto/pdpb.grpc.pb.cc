...
::grpc::Status PD::Stub::AskBatchSplit(::grpc::ClientContext* context, const ::pdpb::AskBatchSplitRequest& request, ::pdpb::AskBatchSplitResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AskBatchSplit_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::pdpb::AskBatchSplitResponse>* PD::Stub::AsyncAskBatchSplitRaw(::grpc::ClientContext* context, const ::pdpb::AskBatchSplitRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::pdpb::AskBatchSplitResponse>::Create(channel_.get(), cq, rpcmethod_AskBatchSplit_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::pdpb::AskBatchSplitResponse>* PD::Stub::PrepareAsyncAskBatchSplitRaw(::grpc::ClientContext* context, const ::pdpb::AskBatchSplitRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::pdpb::AskBatchSplitResponse>::Create(channel_.get(), cq, rpcmethod_AskBatchSplit_, context, request, false);
}

::grpc::Status PD::Stub::ReportBatchSplit(::grpc::ClientContext* context, const ::pdpb::ReportBatchSplitRequest& request, ::pdpb::ReportBatchSplitResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ReportBatchSplit_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::pdpb::ReportBatchSplitResponse>* PD::Stub::AsyncReportBatchSplitRaw(::grpc::ClientContext* context, const ::pdpb::ReportBatchSplitRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::pdpb::ReportBatchSplitResponse>::Create(channel_.get(), cq, rpcmethod_ReportBatchSplit_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::pdpb::ReportBatchSplitResponse>* PD::Stub::PrepareAsyncReportBatchSplitRaw(::grpc::ClientContext* context, const ::pdpb::ReportBatchSplitRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::pdpb::ReportBatchSplitResponse>::Create(channel_.get(), cq, rpcmethod_ReportBatchSplit_, context, request, false);
}
...
::grpc::Status PD::Service::AskBatchSplit(::grpc::ServerContext* context, const ::pdpb::AskBatchSplitRequest* request, ::pdpb::AskBatchSplitResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status PD::Service::ReportBatchSplit(::grpc::ServerContext* context, const ::pdpb::ReportBatchSplitRequest* request, ::pdpb::ReportBatchSplitResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
