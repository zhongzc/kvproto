...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "coprocessor.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void Request::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->ranges(static_cast<int>(i)), output);
  }
...
::google::protobuf::uint8* Response::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_region_error()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *this->region_error_, deterministic, target);
  }
  ...
  if (this->has_locked()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, *this->locked_, deterministic, target);
  }
  ...
  if (this->has_range()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, *this->range_, deterministic, target);
  }
  ...
  if (this->has_exec_details()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, *this->exec_details_, deterministic, target);
  }
