 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status UnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>> AsyncUnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>>(AsyncUnsafeDestroyRangeRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>> PrepareAsyncUnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>>(PrepareAsyncUnsafeDestroyRangeRaw(context, request, cq));
    }
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>* AsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::kvrpcpb::UnsafeDestroyRangeResponse>* PrepareAsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status UnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>> AsyncUnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>>(AsyncUnsafeDestroyRangeRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>> PrepareAsyncUnsafeDestroyRange(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>>(PrepareAsyncUnsafeDestroyRangeRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>* AsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::kvrpcpb::UnsafeDestroyRangeResponse>* PrepareAsyncUnsafeDestroyRangeRaw(::grpc::ClientContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Store commands (to the whole tikv but not a certain region)
    virtual ::grpc::Status UnsafeDestroyRange(::grpc::ServerContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest* request, ::kvrpcpb::UnsafeDestroyRangeResponse* response);
    // SQL push down commands.
  ...
  class WithAsyncMethod_UnsafeDestroyRange : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithAsyncMethod_UnsafeDestroyRange() {
      ::grpc::Service::MarkMethodAsync(21);
    }
    ~WithAsyncMethod_UnsafeDestroyRange() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ...
    void RequestUnsafeDestroyRange(::grpc::ServerContext* context, ::kvrpcpb::UnsafeDestroyRangeRequest* request, ::grpc::ServerAsyncResponseWriter< ::kvrpcpb::UnsafeDestroyRangeResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithGenericMethod_UnsafeDestroyRange : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithGenericMethod_UnsafeDestroyRange() {
      ::grpc::Service::MarkMethodGeneric(21);
    }
    ~WithGenericMethod_UnsafeDestroyRange() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnsafeDestroyRange(::grpc::ServerContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest* request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) final override {
   ...
   public:
    WithStreamedUnaryMethod_UnsafeDestroyRange() {
      ::grpc::Service::MarkMethodStreamed(21,
        new ::grpc::internal::StreamedUnaryHandler< ::kvrpcpb::UnsafeDestroyRangeRequest, ::kvrpcpb::UnsafeDestroyRangeResponse>(std::bind(&WithStreamedUnaryMethod_UnsafeDestroyRange<BaseClass>::StreamedUnsafeDestroyRange, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_UnsafeDestroyRange() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status UnsafeDestroyRange(::grpc::ServerContext* context, const ::kvrpcpb::UnsafeDestroyRangeRequest* request, ::kvrpcpb::UnsafeDestroyRangeResponse* response) final override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedUnsafeDestroyRange(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::kvrpcpb::UnsafeDestroyRangeRequest,::kvrpcpb::UnsafeDestroyRangeResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
