...
class UnsafeDestroyRangeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.UnsafeDestroyRangeRequest) */ {
 public:
  ...
  #if LANG_CXX11
  UnsafeDestroyRangeRequest(UnsafeDestroyRangeRequest&& from) noexcept
    : UnsafeDestroyRangeRequest() {
    *this = ::std::move(from);
  }
  ...
  static inline const UnsafeDestroyRangeRequest* internal_default_instance() {
    return reinterpret_cast<const UnsafeDestroyRangeRequest*>(
               &_UnsafeDestroyRangeRequest_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    64;

  void Swap(UnsafeDestroyRangeRequest* other);
  friend void swap(UnsafeDestroyRangeRequest& a, UnsafeDestroyRangeRequest& b) {
    a.Swap(&b);
  }
...
class UnsafeDestroyRangeResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kvrpcpb.UnsafeDestroyRangeResponse) */ {
 public:
  ...
  #if LANG_CXX11
  UnsafeDestroyRangeResponse(UnsafeDestroyRangeResponse&& from) noexcept
    : UnsafeDestroyRangeResponse() {
    *this = ::std::move(from);
  }
  ...
  static inline const UnsafeDestroyRangeResponse* internal_default_instance() {
    return reinterpret_cast<const UnsafeDestroyRangeResponse*>(
  ...
  friend void swap(UnsafeDestroyRangeResponse& a, UnsafeDestroyRangeResponse& b) {
    a.Swap(&b);
  }
