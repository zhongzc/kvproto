...
public:
    ...
    public:
        ...
        std::unique_ptr<::grpc::ClientReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        ApplyCommand(::grpc::ClientContext * context)
        {
            return std::unique_ptr<::grpc::ClientReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>(
                ApplyCommandRaw(context));
        }
        std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        AsyncApplyCommand(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq, void * tag)
        {
            return std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>(
                AsyncApplyCommandRaw(context, cq, tag));
        }
        std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        PrepareAsyncApplyCommand(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq)
        {
            return std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse>>(
                PrepareAsyncApplyCommandRaw(context, cq));
        }
    ...
    private:
        virtual ::grpc::ClientReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse> *
        ApplyCommandRaw(::grpc::ClientContext * context)
            = 0;
        virtual ::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse> *
        AsyncApplyCommandRaw(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq, void * tag)
            = 0;
        virtual ::grpc::ClientAsyncReaderWriterInterface<::enginepb::CommandRequet, ::enginepb::CommandResponse> *
        PrepareAsyncApplyCommandRaw(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq)
            = 0;
    ...
    public:
        ...
        std::unique_ptr<::grpc::ClientReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        ApplyCommand(::grpc::ClientContext * context)
        {
            return std::unique_ptr<::grpc::ClientReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse>>(
                ApplyCommandRaw(context));
        }
        std::unique_ptr<::grpc::ClientAsyncReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        AsyncApplyCommand(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq, void * tag)
        {
            return std::unique_ptr<::grpc::ClientAsyncReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse>>(
                AsyncApplyCommandRaw(context, cq, tag));
        }
        std::unique_ptr<::grpc::ClientAsyncReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse>>
        PrepareAsyncApplyCommand(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq)
    ...
    private:
        ...
        ApplyCommandRaw(::grpc::ClientContext * context) override;
        ::grpc::ClientAsyncReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse> *
        AsyncApplyCommandRaw(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq, void * tag) override;
        ::grpc::ClientAsyncReaderWriter<::enginepb::CommandRequet, ::enginepb::CommandResponse> *
                                                                 PrepareAsyncApplyCommandRaw(::grpc::ClientContext * context, ::grpc::CompletionQueue * cq) override;
        ...
        const ::grpc::internal::RpcMethod                        rpcmethod_ApplyCommand_;
    ...
    public:
        Service();
        virtual ~Service();
        virtual ::grpc::Status ApplyCommand(::grpc::ServerContext *                                                              context,
    ...
    class WithAsyncMethod_ApplyCommand : public BaseClass
    {
    private:
        void BaseClassMustBeDerivedFromService(const Service * service) {}

    public:
        WithAsyncMethod_ApplyCommand() { ::grpc::Service::MarkMethodAsync(0); }
        ~WithAsyncMethod_ApplyCommand() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status
        ApplyCommand(::grpc::ServerContext *                                                              context,
                     ::grpc::ServerReaderWriter<::enginepb::CommandResponse, ::enginepb::CommandRequet> * stream) final override
        {
            abort();
            return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
        }
        void RequestApplyCommand(::grpc::ServerContext *                                                                   context,
                                 ::grpc::ServerAsyncReaderWriter<::enginepb::CommandResponse, ::enginepb::CommandRequet> * stream,
    ...
    typedef WithAsyncMethod_ApplyCommand<WithAsyncMethod_ApplySnapshot<Service>> AsyncService;
    template <class BaseClass>
    class WithGenericMethod_ApplyCommand : public BaseClass
    {
    private:
        void BaseClassMustBeDerivedFromService(const Service * service) {}

    public:
        WithGenericMethod_ApplyCommand() { ::grpc::Service::MarkMethodGeneric(0); }
        ~WithGenericMethod_ApplyCommand() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status
        ApplyCommand(::grpc::ServerContext *                                                              context,
                     ::grpc::ServerReaderWriter<::enginepb::CommandResponse, ::enginepb::CommandRequet> * stream) final override
