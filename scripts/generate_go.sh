...
function gen() {
    ...
    protoc -I.:../include --grpc-gateway_out=logtostderr=true:../pkg/$base_name --gofast_out=Mgoogle/protobuf/empty.proto=github.com/gogo/protobuf/types,plugins=grpc,$GO_OUT_M:../pkg/$base_name $1 || ret=$?
    cd ../pkg/$base_name
